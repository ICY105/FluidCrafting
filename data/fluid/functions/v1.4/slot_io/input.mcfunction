...
function fluid:v1.4/utils/get_fluids
...
execute if data storage fluid:io input.input_slot.components."minecraft:custom_data".fluid run scoreboard players set #slot_io.input_item fluid.data -1
execute if score #slot_io.input_item fluid.data matches -1 store result score #slot_io.output_amount fluid.data run data get storage fluid:io input.input_slot.components."minecraft:custom_data".fluid.max_storage
execute if score #slot_io.input_item fluid.data matches -1 if score #slot_io.output_amount fluid.data > #slot_io.storage fluid.data if data storage fluid:io input.input_slot.components."minecraft:custom_data".fluid{fixed_storage:0b} run scoreboard players operation #slot_io.output_amount fluid.data = #slot_io.storage fluid.data

execute if data storage fluid:io input.input_slot.components."minecraft:custom_data".fluid.id run scoreboard players set #slot_io.input_item fluid.data 1
execute if score #slot_io.input_item fluid.data matches 1 run data modify storage fluid:io fluid2 set from storage fluid:io input.input_slot.components."minecraft:custom_data".fluid
execute if score #slot_io.input_item fluid.data matches 1 store result score #slot_io.item_storage fluid.data run data get storage fluid:io input.input_slot.components."minecraft:custom_data".fluid.storage
...
execute if score #slot_io.input_item fluid.data matches 1 if score #slot_io.input_amount fluid.data > #slot_io.available_storage fluid.data if data storage fluid:io input.input_slot.components."minecraft:custom_data".fluid{fixed_storage:0b} run scoreboard players operation #slot_io.input_amount fluid.data = #slot_io.available_storage fluid.data
execute if score #slot_io.input_item fluid.data matches 1 run data modify storage fluid:io fluid2 set from storage fluid:io input.input_slot.components."minecraft:custom_data".fluid
...
execute if score #slot_io.input_item fluid.data matches 0 run function fluid:v1.4/slot_io/get_vanilla_item
execute store result score #slot_io.input_count fluid.data run data get storage fluid:io input.input_slot.count

# split
execute if score #slot_io.input_item fluid.data matches -1 if score #slot_io.output_count fluid.data matches 0 if score #slot_io.output_count fluid.data matches 0 if score #slot_io.storage fluid.data >= #slot_io.output_amount fluid.data run function fluid:v1.4/slot_io/withdraw_custom
execute if score #slot_io.input_item fluid.data matches 1 if score #slot_io.output_count fluid.data matches 0 if score #slot_io.available_storage fluid.data >= #slot_io.input_amount fluid.data run function fluid:v1.4/slot_io/deposit_custom

execute if score #slot_io.input_item fluid.data matches ..-2 if score #slot_io.output_count fluid.data matches 0 if score #slot_io.storage fluid.data >= #slot_io.output_amount fluid.data run function fluid:v1.4/slot_io/withdraw_vanilla
execute if score #slot_io.input_item fluid.data matches 2.. if score #slot_io.available_storage fluid.data >= #slot_io.input_amount fluid.data run function fluid:v1.4/slot_io/deposit_vanilla
...
function fluid:v1.4/utils/store_fluids
