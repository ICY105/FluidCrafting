...
execute if score @s fluid.transfer_rate < @s fluid.transfer_capacity run scoreboard players operation @e[tag=fluid.pipe,predicate=fluid:v1.6/equals_network_id] fluid.transfer_capacity = @s fluid.transfer_rate
