...
function fluid:v1.6/utils/get_fluids
...
execute if score #slot_io.input_item fluid.data matches 0 run function fluid:v1.6/slot_io/get_vanilla_item
execute store result score #slot_io.input_count fluid.data run data get storage fluid:io input.input_slot.count

# split
execute if score #slot_io.input_item fluid.data matches -1 if score #slot_io.output_count fluid.data matches 0 if score #slot_io.output_count fluid.data matches 0 if score #slot_io.storage fluid.data >= #slot_io.output_amount fluid.data run function fluid:v1.6/slot_io/withdraw_custom
execute if score #slot_io.input_item fluid.data matches 1 if score #slot_io.output_count fluid.data matches 0 if score #slot_io.available_storage fluid.data >= #slot_io.input_amount fluid.data run function fluid:v1.6/slot_io/deposit_custom

execute if score #slot_io.input_item fluid.data matches ..-2 if score #slot_io.output_count fluid.data matches 0 if score #slot_io.storage fluid.data >= #slot_io.output_amount fluid.data run function fluid:v1.6/slot_io/withdraw_vanilla
execute if score #slot_io.input_item fluid.data matches 2.. if score #slot_io.available_storage fluid.data >= #slot_io.input_amount fluid.data run function fluid:v1.6/slot_io/deposit_vanilla
...
function fluid:v1.6/utils/store_fluids
