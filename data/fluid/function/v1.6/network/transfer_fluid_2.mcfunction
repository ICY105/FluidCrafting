...
execute if entity @s[tag=fluid.current] run function fluid:v1.6/network/transfer_fluid_2_current
execute if entity @s[tag=fluid.current] run return 0

function fluid:v1.6/utils/get_fluids_slot_2
...
execute if score #utils.out.3 fluid.data matches 1 if score @s fluid.storage.3 matches 1.. if data storage fluid:io fluids2[3].id run function fluid:v1.6/utils/check_id
...
execute if score #utils.out.2 fluid.data matches 1 if score @s fluid.storage.2 matches 1.. if data storage fluid:io fluids2[2].id run function fluid:v1.6/utils/check_id
...
execute if score #utils.out.1 fluid.data matches 1 if score @s fluid.storage.1 matches 1.. if data storage fluid:io fluids2[1].id run function fluid:v1.6/utils/check_id
...
execute if score #utils.out.0 fluid.data matches 1 if score @s fluid.storage.0 matches 1.. if data storage fluid:io fluids2[0].id run function fluid:v1.6/utils/check_id
