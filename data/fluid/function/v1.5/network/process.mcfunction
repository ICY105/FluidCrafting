...
execute if score #network.io fluid.data matches ..-1 unless score #network.network_id fluid.data matches 0 if score #network.transfer_rate fluid.data matches 1.. run function fluid:v1.5/network/process_2
